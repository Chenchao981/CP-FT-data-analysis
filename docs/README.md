...
- [FTP 对接设计与输入合同](architecture/NCE_PYMS_FTP_Integration_Design_2026-09-05.md) / [开发测试完成报告](development/NCE_PYMS_FTP_Integration_Completion_Report_2026-09-05.md)：当前 sql2014_0029，自动采集、事务去重与真实本地 FTP→正式数据验证；企业服务器联调待提供参数。
...
- [CP/FT 物理分表完成报告](development/NCE_PYMS_Physical_Stage_Storage_Completion_Report_2026-09-05.md)：sql2014_0028 阶段的全量历史对账及真实入库验证。
