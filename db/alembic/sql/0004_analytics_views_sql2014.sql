...
CREATE VIEW analytics.v_current_dataset_version
AS
SELECT
    d.dataset_id,
    d.dataset_code,
...
CREATE VIEW analytics.v_current_test_run
AS
...
CREATE VIEW analytics.v_current_unit_result
AS
...
CREATE VIEW analytics.v_current_measurement
AS
