...
CURRENT_SCHEMA_HEAD = "sql2014_0029"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            'database.get("schema_revision") != "sql2014_0029"',
        ),
        (
            "scripts/g0/verify_route_a_worker_foundation.py",
            'assert revision == "sql2014_0029"',
        ),
        (
        ...
        (
            ...
            'identity["revision"] != "sql2014_0029"',
        ),
        (
