...
CURRENT_SCHEMA_HEAD = "sql2014_0026"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            'database.get("schema_revision") != "sql2014_0026"',
        ),
        (
            "scripts/g0/verify_route_a_worker_foundation.py",
            'assert revision == "sql2014_0026"',
        ),
        (
        ...
        (
            ...
            'identity["revision"] != "sql2014_0026"',
        ),
        (
