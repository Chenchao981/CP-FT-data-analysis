import { CloudServerOutlined, DashboardOutlined, ExperimentOutlined, LinkOutlined, LogoutOutlined, PlayCircleOutlined, ProfileOutlined, RadarChartOutlined, SafetyCertificateOutlined, ThunderboltOutlined, UserOutlined } from "@ant-design/icons";
...
const SourceCenter = lazy(() => import("./features/sources/SourceCenter").then((module) => ({ default: module.SourceCenter })));
...
const routes: AppRoute[] = [
  ...
  { path: "/quick-analysis", name: "个人分析工具", icon: <PlayCircleOutlined />, permission: "ANALYSIS_RUN" },
  { path: "/datasets/current", name: "产品与批次", icon: <ProfileOutlined />, permission: "DATASET_READ" },
  { path: "/management/quality", name: "良率与质量", icon: <DashboardOutlined />, permission: ["MANAGEMENT_READ", "RULE_GOVERN"] },
  { path: "/master-data/product-crosswalks", name: "产品映射", icon: <LinkOutlined />, permission: ["MANAGEMENT_READ", "RULE_GOVERN"] },
  { path: "/data-sources", name: "数据源中心", icon: <CloudServerOutlined />, permission: "TASK_CREATE" },
...
export default function App() {
  ...
  return <ProLayout
    title="NCE PYMS"
    logo={<img className="brand-logo-image" src="/tms-logo.png" alt="新洁能 PYMS" />}
    layout="mix"
    fixedHeader
    fixSiderbar
