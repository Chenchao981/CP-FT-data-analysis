...
describe("management api", () => {
  it("loads the filtered quality summary through the authenticated client", async () => {
    ...
    expect(url).toBe("/api/v1/management/quality-summary?from_utc=2026-08-01T00%3A00%3A00Z&to_utc=2026-09-01T00%3A00%3A00Z&business_domain=PRODUCTION&test_stage=FT&factory_code=riyuexin&product_name=NCE+MOS&lot_id=LOT%2F01&recent_limit=15");
