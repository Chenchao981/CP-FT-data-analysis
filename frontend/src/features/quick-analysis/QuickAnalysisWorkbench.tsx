...
export function QuickAnalysisWorkbench() {
  ...
  return <div className="workbench quick-analysis-workbench">
    ...
    <Alert className="quick-analysis-alert" showIcon type="info" message="当前可运行：CP / FT 原始目录 → 厂商工具 PAT Excel" description="FT 直接复用杰群桌面工具的低内存 PAT；CP 先调用华虹、积塔、立昂微或国宇的已发布 Cleaner，再由同一 CP 工具包执行 PAT。系统只保存结果，不写入正式 Canonical，默认 7 天后过期。" />
