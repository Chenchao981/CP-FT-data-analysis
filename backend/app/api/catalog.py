...
def list_current_datasets(
    ...
    wafer_id: str | None = Query(default=None, max_length=64),
    import_batch_id: int | None = Query(default=None, ge=1),
    cleaner_version: str | None = Query(default=None, max_length=128),
    owner_login: str | None = Query(default=None, max_length=128),
