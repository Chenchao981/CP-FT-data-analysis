...
- [FTP 对接设计与输入合同](docs/architecture/NCE_PYMS_FTP_Integration_Design_2026-09-05.md) / [开发测试完成报告](docs/development/NCE_PYMS_FTP_Integration_Completion_Report_2026-09-05.md)：当前 sql2014_0029，自动采集、事务去重与真实本地 FTP→正式数据验证；企业服务器联调待提供参数。
...
- [CP/FT 物理分表完成报告](docs/development/NCE_PYMS_Physical_Stage_Storage_Completion_Report_2026-09-05.md)：sql2014_0028 阶段的全量历史对账及真实入库验证。
...
- [数据库阶段字段字典](docs/architecture/NCE_PYMS_Database_Stage_Fields_2026-09-05.md)：CP/FT 运行身份、来源和规格字段。
- [2026-09-05 架构与可用性优化验收](docs/development/NCE_PYMS_Architecture_Usability_Completion_Report_2026-09-05.md)：本次完成项、实测性能与未验收边界。
- [CP/FT 阶段合同与扩展指南](docs/architecture/NCE_PYMS_Stage_Contracts_and_Extension_Guide_2026-09-05.md)：当前代码分层和新厂家扩展。
